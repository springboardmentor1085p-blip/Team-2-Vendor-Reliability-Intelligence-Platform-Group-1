...
# ── NEW in Milestone 2 ────────────────────────────────────────────────────────
from po_dashboard_router import router as po_router
from purchase_orders_router import router as purchase_orders_router
# ─────────────────────────────────────────────────────────────────────────────



# Create all tables on startup (vendors + purchase_orders)
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:4200",   # same server accessed via IP
    ],
...
# ── NEW in Milestone 2: register the PO dashboard router + full CRUD router ───
